...
void main() {
  ...
  try {
    ...
    print(
      "Parsed successfully. Total amount: \${model.data.first.totalAmount}",
    );

    // Testing specific types
    print("itemCount type: \${model.data.first.itemCount.runtimeType}");
    print("totalAmount type: \${model.data.first.totalAmount.runtimeType}");
    print("price type: \${model.data.first.items.first.price.runtimeType}");
  } catch (e, stacktrace) {
